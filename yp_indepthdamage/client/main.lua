...
local engineFactor = 14.0 --Rate at which collisions affect engine damage, higher the number the more damage per colision
local bodyFactor = 14.0 --Rate at which collisions affect body damage, 
